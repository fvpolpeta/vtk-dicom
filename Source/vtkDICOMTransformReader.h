...
// object consisting of a vtkGridTransform, and a pre-deformation or
// post-deformation matrix (or both) stored as a vtkTransform.  You can
// decompose a vtkGeneralTransform with GetNumberOfConcatenatedTransforms()
...
class VTK_DICOM_EXPORT vtkDICOMTransformReader : public vtkAlgorithm
{
public:
  ...
  // In general, there will only be one registration per file.
